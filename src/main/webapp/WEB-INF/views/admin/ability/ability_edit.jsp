		...
		<form class="col s12" method="POST"	action="<c:url value='/admin/ability/ability_merge'/>">
			...
			<div class="row">
				<div class="input-field col s12">
					<input name="ABILITY_SEQ" id="ability_seq" type="text" class="validate" value="${resultMap.ABILITY_SEQ}" readOnly> <label
			...
			<div class="row">
				<div class="input-field col s12">
					<input name="ABILITY_NAME" id="ability_name" type="text" class="validate" value="${resultMap.ABILITY_NAME}"> <label
