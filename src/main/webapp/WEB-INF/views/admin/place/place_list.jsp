...
<div class="main_body" style="width: 70%">
	...
	<div class="row">
		<div class="card col s12" style="padding: 0">
			<ul class="tabs">
				<li class="tab col s3"><a class="active" href="#equip1">세미나룸</a></li>
				<li class="tab col s3"><a href="#equip2">컴퓨터실</a></li>
				<li class="tab col s3"><a href="#equip3">목공실</a></li>
				<li class="tab col s3"><a href="#equip4">봉제실</a></li>
			</ul>
		</div>
				...
				<div class="col s12 m4">
					<div class="card">
						<div class="card-image waves-effect waves-block waves-light">
							<img class="activator"
								src="<c:url value='/resources/images/creationRoom.PNG'/>">
						</div>
